...
int main(int argn, char** args){
	...
	printf("Start of Run... \n");
			...
			printf("P1. Tanker SideSection 50percent without baffle \n");
			printf("P2. Tanker SideSection 50percent with baffle \n");
			printf("P3. Tanker SideSection 80percent without baffle \n");
			printf("P4. Tanker SideSection 80percent with baffle \n");
			printf("P2. droplet \n");
